  ...
  const handleGoogleLogin = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        queryParams: {
          hd: 'svce.ac.in', // Restrict to college domain
        },
      },
    });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Track your attendance, never miss the 75%
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
            <p className="text-blue-800 dark:text-blue-200 text-xs">
              <strong>Note:</strong> Only <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">@svce.ac.in</code> email addresses are allowed.
            </p>
          </div>
        </div>
