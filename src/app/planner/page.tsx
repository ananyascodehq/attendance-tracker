...
export default function PlannerPage() {
  ...
  if (!data) {
    return <div className="text-center text-gray-700 dark:text-gray-200 py-20">No semester data found. <a href="/onboarding" className="text-blue-500 underline">Set up a semester</a> first.</div>;
  }
